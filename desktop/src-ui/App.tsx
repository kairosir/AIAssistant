  ...
  return <main className="account-view">
    ...
    <div className="account-app-content">
      ...
      <section className="account-app-grid">
        ...
        <article><div className="account-metric-icon"><MonitorCheck size={19} /></div><span><small>ЭТО УСТРОЙСТВО</small><strong>OfficeGhost 0.3.3</strong><p>{updateStatus.available ? `Доступно обновление ${updateStatus.version}` : "Приложение подключено к аккаунту."}</p></span></article>
      </section>
